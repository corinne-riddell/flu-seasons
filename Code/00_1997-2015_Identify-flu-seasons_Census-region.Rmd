...
#this is because the last week of one year and the first week of the next year are the same week! But somehow the CDC has different data for those eg look at counter =  141-149 and tge proceeding rows
...
No <- Northeast_summary$p1/Northeast_summary$num_test_p1
